...
public class ViewActions {
    ...
    public ViewActions() {
        ...
        actions.add(new ZoomInAction("Zoom In", "zoomIn", "Zoom In", Integer.valueOf(KeyEvent.VK_EQUALS)));
        actions.add(new ZoomOutAction("Zoom Out", "zoomOut", "Zoom Out", Integer.valueOf(KeyEvent.VK_MINUS)));
        actions.add(new ZoomFullAction("Zoom Full", "zoomFull", "Zoom Full", Integer.valueOf(KeyEvent.VK_1)));
    }
    ...
    public ArrayList<Action> getTools() {
        ...
        viewTools.add(actions.get(0));
        viewTools.add(actions.get(1));
        return viewTools;
    }
    ...
    public class ZoomInAction extends ImageAction {
         ...
         */
        ZoomInAction(String name, String iconName, String desc, Integer mnemonic) {
    ...
    public class ZoomOutAction extends ImageAction {
         ...
         * @param mnemonic A mnemonic key to use as a shortcut (ignored if null).
         */
        ZoomOutAction(String name, String iconName, String desc, Integer mnemonic) {
            super(name, iconName, desc, mnemonic);
    ...
    public class ZoomFullAction extends ImageAction {
         ...
         * @param mnemonic A mnemonic key to use as a shortcut (ignored if null).
         */
        ZoomFullAction(String name, String iconName, String desc, Integer mnemonic) {
            super(name, iconName, desc, mnemonic);
        }
