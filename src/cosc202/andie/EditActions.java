...
public class EditActions {
    ...
    public EditActions() {
        ...
        actions.add(new UndoAction("Undo", "undo", "Undo", Integer.valueOf(KeyEvent.VK_Z)));
        actions.add(new RedoAction("Redo", "redo", "Redo", Integer.valueOf(KeyEvent.VK_Y)));
    }
    ...
    public class UndoAction extends ImageAction {
         ...
         */
        UndoAction(String name, String iconName, String desc, Integer mnemonic) {
    ...
    public class RedoAction extends ImageAction {
         ...
         * @param mnemonic A mnemonic key to use as a shortcut (ignored if null).
         */
        RedoAction(String name, String iconName, String desc, Integer mnemonic) {
            super(name, iconName, desc, mnemonic);
        }
